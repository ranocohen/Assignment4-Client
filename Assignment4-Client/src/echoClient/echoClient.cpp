...
>>>>>>> branch 'master' of https://github.com/ranocohen/Assignment4-Client.git
	...
	// ce b5 = epsilon              = 03b5
	// a = new line					= 000a
	unsigned char greek[] = { 0x20, 0xce, 0xba, 0xe1, 0xbd, 0xb9, 0xcf, 0x83,
			0xce, 0xbc, 0xce, 0xb5, 0x0a, 0x00 };
...
=======
	...
	std::cout << "Length of greek is " << lg << " UTF-8 chars in "
			<< strlen(utf8g.c_str()) << " bytes" << std::endl;
